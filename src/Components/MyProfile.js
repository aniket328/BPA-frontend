...
const LandingPage = () => {
    ...
    return (
        ...
        <div className="flex overflow-y-auto py-20 w-full h-[calc(100vh-100px)]" >
         ...
         <div className="w-3/4 p-4 flex flex-col justify-center items-start ">
                    <p className="text-xl mb-8 font-bold">-Name</p>
                    <p className="text-xl mb-8 font-bold">-Plot Number:</p>
                    <p className="text-xl mb-8 font-bold">-Sector Number</p>
                    <p className="text-xl mb-8 font-bold">-Name of Urban Estate</p>
                    <p className="text-xl mb-8 font-bold">-Zone(Delhi)</p>
                    <p className="text-xl mb-8 font-bold">-Area</p>
                    <p className="text-xl mb-8 font-bold">-Commercial/Residential/Industrial</p>
